...
<body class="m-0 " style="background-color: #FBB7C7">
    ...
    <div class="row sticky-top text-center" style="background-color: #FAD9D5">
        <div class="go-home col pt-2">
            <form action="{{ route('admin.go-home') }}" method="post">
                @csrf
                <button type="submit">< Back</button>
            </form>
        </div>
        <div class="col">
            <h1 style="color: #C0CEED; font-family: 'Nerko One', cursive; font-size: 40px;">
    ...
    <div class="create-chat sticky-bottom p-2 text-center">
        <form action="{{ route('admin.create-chat', $id) }}" method="post" autocomplete="off">
            @csrf
